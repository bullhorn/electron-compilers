 ...
 * express-compile. If your compiler library only supports a
...
export class CompilerBase {
   ...
   * versions of express-compile, we will use this information to invalidate
   ...
   * compiler library. When this number changes, express-compile knows
